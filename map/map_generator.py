...
from .gpu_helpers import binary_dilation, trace_river_dijkstra, timer
...
class MapGenerator:
    ...
    def generate(self):
        ...
        sea_mask = self.generate_sea_mask(height_map)
    ...
    def generate_sea_mask(self, height_map):
        ...
        self.sea_level = sea_level  # store for later use in fertility and forest maps
        return sea_mask
